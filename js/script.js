function readForm1(){
    ...
    if (name_form1 == "" || adres_form1 == "" || phone_form1 == "" || pay_form1 == ""){
        ...
        if(name_form1==""){
            document.getElementById("check1_false").innerHTML = "incorect";
        ...
        if(adres_form1==""){
            document.getElementById("check2_false").innerHTML = "incorect";
        ...
        if(phone_form1==""){ 
            document.getElementById("check3_false").innerHTML = "incorect";
...
function readForm2(){
    ...
    if(name_form2 == "" || surname_form2 =="" || phone_form2 =="" || city_form2 ==""|| date_form2 ==""){
        if(name_form2 == ""){
            document.getElementById("check1_false2").innerHTML = "incorect";
        ...
        if(surname_form2 == ""){
            document.getElementById("check2_false2").innerHTML = "incorect";
        ...
        if(phone_form2 == ""){
            document.getElementById("check3_false2").innerHTML = "incorect";
        ...
        if(city_form2 == ""){
            document.getElementById("check4_false2").innerHTML = "incorect";
        ...
        if(date_form2 == ""){
            document.getElementById("check5_false2").innerHTML = "incorect";
